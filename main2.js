...
const mType = document.getElementById("monster-type");
    ...
    if (data.success) {
      ...
      if(yugiBool){
        ...
        if(rawText.includes('Card Type: Fusion') || rawText.includes('Card Type: Effect') || rawText.includes('Card Type: Synchro') || rawText.includes('Card Type: Xyz')){
          ...
          if(rawText.includes("Monster Type: ")){
            monsterTypeM = traitScrape(rawText, 'Monster Type: ', ',').toUpperCase();
            if (rawText.includes('Card Type: Effect')) {
              mType.textContent = monsterTypeM+"/EFFECT"
            } else if(rawText.includes('Card Type: Fusion')){
              mType.textContent = monsterTypeM+"/FUSION/EFFECT"
            }else if(rawText.includes('Card Type: Synchro')){
              mType.textContent = monsterTypeM+"/SYNCHRO/EFFECT"
            }else if(rawText.includes('Card Type: Xyz')){
              mType.textContent = monsterTypeM+"/XYZ/EFFECT"
            }
          }
        }
      }
